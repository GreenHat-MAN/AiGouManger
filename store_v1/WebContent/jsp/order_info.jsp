...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<div>
				<hr/>
				<form class="form-horizontal" style="margin-top:5px;margin-left:150px;" method="post" action="${pageContext.request.contextPath}/OrderServlet">
				...
				<div style="margin-top:5px;">
					...
					<p style="text-align:right;margin-right:100px;">
						<button type="submit" style="border: 0px solid;background-color: white">
